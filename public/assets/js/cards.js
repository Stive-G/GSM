document.addEventListener('DOMContentLoaded', () => {
    ...
    const moneySuffix = () => {
        if (window.APP_CURRENCY === 'XAF') return ' ' + (window.APP_CURRENCY_LABEL || 'FCFA');
        return ' €';
    };
    ...
    const openDetails = (p) => {
        ...
        setText('productDetailsHtCurrency', moneySuffix());
        setText('productDetailsTtcCurrency', moneySuffix());
